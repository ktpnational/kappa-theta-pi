        ...
        eventStarted && (
          <div className="mt-12 w-full max-w-3xl">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-blue-200">
              ...
              <h3 className="text-2xl font-bold text-center text-blue-900 mt-8 mb-4">
                Evaluation Rubric
              </h3>
              <ul className="list-disc list-inside text-blue-900 font-semibold">
                <li>
                  <strong>Relevance to the Challenge:</strong> Does the solution
                  directly address the challenge of organizing and preserving
                  chapter history?
                </li>
                <li>
                  <strong>Innovation & Creativity:</strong> How unique and
                  creative is the solution?
                </li>
                <li>
                  <strong>Functionality:</strong> Is the platform functional and
                  capable of organizing, uploading, and accessing content?
                </li>
                <li>
                  <strong>User Experience (UX):</strong> Is the platform
                  intuitive, visually appealing, and easy to navigate?
                </li>
                <li>
                  <strong>Scalability & Maintenance:</strong> Can the solution
                  handle long-term growth and future chapter needs?
                </li>
              </ul>
              <div className="text-center mt-6">
                <a
                  href="https://forms.gle/rbLJeyH5xaUJvBp4A"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white bg-blue-900 px-4 py-2 rounded-lg font-semibold hover:bg-blue-800 transition"
                >
                  Submit your Founder's Day Project
                </a>
              </div>
              <div className="mt-6">
                <p className="text-blue-700 italic"></p>
