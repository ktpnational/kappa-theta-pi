    ...
    <div className="min-h-screen px-6 py-12 bg-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-12">
          Have questions or want to get in touch? Use the form below, or reach out to us directly!
        </p>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <form action="mailto:contact@kappathetapi.org" method="POST" encType="text/plain">
              <div className="mb-4">
              ...
              <div className="text-center">
                <button type="submit" className="w-full bg-blue text-white py-3 px-6 rounded-lg">
                  Send Message
                </button>
              </div>
            </form>
